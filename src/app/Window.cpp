...
void Window::onKeyEvent([[maybe_unused]] GLFWwindow *window,
                        ...
                        int action,
                        int mods) {
  App::Instance().onKeyEvent(key, scancode, action, mods);
}
